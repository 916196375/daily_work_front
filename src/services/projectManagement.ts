 ...
 * @LastEditTime: 2023-06-21 21:49:07
...
import { UpdateTaskParams } from "@/pages/ProjectManagement/ProjectList/components/TaskTable/const"
...
export async function getTaskDetail(params: { taskId: string }) {
    return request.get<null>('/task/detail', params)
}